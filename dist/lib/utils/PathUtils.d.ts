 ...
 */
export declare function getFilePath(storagePath: string, fileName: string, extension?: string): string;
/**
 ...
 */
export declare function getFileNameFromFilePath(filePath: string, withExtension?: boolean): string;
